...
class DoubleRoundRobinTests(unittest.TestCase):
    def test_openrouter_codenames_model_list_reflects_the_updated_18_model_field(self):
        ...
        self.assertIn("meta-llama/llama-4-maverick", slugs)
        ...
        self.assertIn("z-ai/glm-4.6v", slugs)
        self.assertIn("mistralai/mistral-small-3.2-24b-instruct", slugs)
        self.assertNotIn("meta-llama/llama-3.3-70b-instruct", slugs)
        self.assertNotIn("google/gemma-4-31b-it", slugs)
        self.assertNotIn("qwen/qwen3-32b", slugs)
        ...
        self.assertEqual(providers["meta-llama/llama-4-maverick"], "Parasail")
        ...
        self.assertEqual(providers["z-ai/glm-4.6v"], "NovitaAI")
        self.assertEqual(providers["mistralai/mistral-small-3.2-24b-instruct"], "DeepInfra")
        self.assertEqual(len(slugs), 18)
        self.assertEqual(slugs[0], "meta-llama/llama-4-maverick")
